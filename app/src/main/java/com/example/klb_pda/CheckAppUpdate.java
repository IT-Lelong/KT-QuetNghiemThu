...
public class CheckAppUpdate {
    ...
    String UPDATE_SERVERAPK = "PDA_PHATHANG_KT_T50C.apk";
    ...
    public void checkVersion() {
        new Asyn_getServerVer().execute("http://172.16.40.20/" + g_server + "/check_ver.php?app=PDA_PHATHANG_KT_T50C");
    }
        ...
        Dialog dialog = new android.app.AlertDialog.Builder(mCtxAPI)
                ...
                .setPositiveButton(mCtxAPI.getString(R.string.ver_update), new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        downFile("http://172.16.40.20/" + g_server + "/AndroidUpdateService/PDA_PHATHANG_KT_T50C.apk");
                    }
                }).create();
