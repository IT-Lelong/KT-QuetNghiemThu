...
public class qrcode_print_DB {
    ...
    String qrb06 = "qrb06"; //轉換率

    String CREATE_TABLE = "CREATE TABLE " + TABLE_NAME + " (" + qrb00 + " INTEGER," + qrb01 + " TEXT," + qrb02 + " TEXT," + qrb03 + " FLOAT,"
                                                              + qrb04 + " TEXT," + qrb05 + " TEXT," + qrb06 + " DOUBLE,"  + " PRIMARY KEY(qrb00))";
    ...
    public void append(int xqrb00, String xqrb01, String xqrb02, String xqrb03, String xqrb04, Double xqrb06) {
        try {
    ...
    public Cursor getAll() {
        try {
            /*return db.query(TABLE_NAME, new String[]{"rowid _id", qrb00, qrb01, qrb02, qrb03, qrb04,qrb06 },
                    null, null, null, null, qrb00, null);*/
            return db.rawQuery("SELECT rowid _id,qrb00, qrb01, qrb02, qrb03, qrb04,(qrb03 / qrb06) qrb06 FROM " + TABLE_NAME + " ORDER BY qrb00", null);
        } catch (Exception e) {
            return null;
        }
