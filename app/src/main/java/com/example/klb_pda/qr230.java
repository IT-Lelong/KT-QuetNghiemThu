...
public class qr230 extends AppCompatActivity {
    ...
    String ID, g_server;
    TextView head1,tv_sfp01,tv_scancode;
    ListView list01;
...
//    static final String SERVICE_NAME = "com.emdoor.scan6703.scanner.ScannerService";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_scancode = (TextView) findViewById(R.id.tv_scancode);
        ...
        tv_scancode.setOnClickListener(tvScanCodeListener);
            ...
            if (datastr.startsWith("new")) {
                Thread api = new Thread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if (qr01.equals("T")) {
                            ...
                            qr03 = Double.parseDouble(datastr.substring(index4 + 1).trim());
                        } else {
                            //批號
                            qr02 = datastr.substring(index2 + 1, index3);
                            //數量
                            qr03 = Double.parseDouble(datastr.substring(index3 + 1).trim());
                        }
                ...
                Thread api = new Thread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if (qr01.equals("T")) {
                            ...
                            //取得數量
                            qr03 = Double.valueOf(datastr.substring(index3 + 1).trim());
                        }
                ...
                Thread api = new Thread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        //廣泰標籤 CC511-2302000001-1000(CC5A1_KD34-2_NULL)_(02100376D_keo trộn_ABS-D150,鐵灰,KT20210408)_20230202045006
                        ...
                        //取得批號
                        String qr02 = getdatecode("http://172.16.40.20/" + g_server + "/PDA_QR230/getDatecode.php?code=" + datastr + "&kind=" + 1);
                        //取得數量
                        if (index2 > 32) {
    ...
    private View.OnClickListener tvScanCodeListener = new View.OnClickListener() {
        @Override
                    ...
                    if (!dialogitem04.getText().toString().equals("ok")) {
                        ...
                        builder1.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                ...
                                Double xqr230b_05 = Double.parseDouble(dialogitem03.getText().toString().trim().replace(",", ""));
