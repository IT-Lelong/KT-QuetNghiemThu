...
public class qr230DB {
    ...
    String CREATE_TABLE = "CREATE TABLE " + TABLE_NAME + " (" + qr230_01 + " INTEGER," + qr230_02 + " TEXT," + qr230_03 + " TEXT," +
            ...
            qr230_07 + " TEXT," + qr230_08 + " TEXT," + qr230_09 + " TEXT," + qr230_10 + " TEXT," + qr230_11 + " TEXT," +" PRIMARY KEY(qr230_01))";
            ...
            if (tcount > 0) {
                ...
                if (tqr230_04 - tqr230_05 - xqr230b_05 >= 0) {
                    ...
                    db.execSQL("INSERT INTO " + TABLE_NAME2 + " (qr230b_01,qr230b_02,qr230b_03,qr230b_04,qr230b_05,qr230b_06,qr230b_07) " +
                            "VALUES(" + tqr230_01 + ",'" + xqr230b_02.trim() + "','" + xqr230b_03 + "','" + xqr230b_04 + "'," + xqr230b_05 + ",'false','" + g_qr230b_07 + "')");
                    return "TRUE";
                } else {
                    return "OVERQTY";
                }
